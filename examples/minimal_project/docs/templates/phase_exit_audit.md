...
Run this audit before locking a phase, moving a request artifact, or handing off active work. If any required item is `No`, stop and resolve it or record an explicit exception.
